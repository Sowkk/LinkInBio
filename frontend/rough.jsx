    ...
    <div style={styles.page}>
      ...
      <div style={styles.card}>
        ...
        <div style={styles.row}>
          <input style={styles.input} placeholder="Title  e.g. My GitHub" value={newTitle} onChange={(e) => setNewTitle(e.target.value)} />
          <input style={styles.input} placeholder="URL  e.g. https://github.com/you" value={newUrl} onChange={(e) => setNewUrl(e.target.value)} />
          ...
          <div key={link.id} style={styles.linkRow}>
            {editingId === link.id ? (
              <div style={styles.editRow}>
                <input style={styles.editInput} value={editForm.title} onChange={(e) => setEditForm({ ...editForm, title: e.target.value })} placeholder="Title" />
                <input style={styles.editInput} value={editForm.url} onChange={(e) => setEditForm({ ...editForm, url: e.target.value })} placeholder="URL" />
              ...
              <>
                ...
                <div style={styles.linkInfo}>
                  <span style={{ ...styles.linkTitle, opacity: link.is_active ? 1 : 0.4 }}>{link.title}</span>
                  <span style={styles.linkUrl}>{link.url}</span>
                </div>

                <div style={styles.linkActions}>
                  <button style={{ ...styles.toggleBtn, background: link.is_active ? "#22c55e22" : "#ffffff11" }} onClick={() => toggleActive(link)}>
      ...
      <div style={styles.card}>
        ...
        <p style={styles.empty}>
          Visit <a href="/analytics" target="_blank" style={styles.link}>/analytics</a> to see click stats
        </p>
      </div>
    </div>
  );
